...
-- Config sliders (NO inicfg - just runtime values)
local buf_hideHud = imgui.new.bool(false)
local buf_hideRadar = imgui.new.bool(false)
local buf_showHP = imgui.new.bool(true)
local buf_showArmor = imgui.new.bool(true)
local buf_showMoney = imgui.new.bool(true)
local buf_showWeapon = imgui.new.bool(true)
local buf_showSpeed = imgui.new.bool(true)
local buf_showFPS = imgui.new.bool(true)
local buf_showZone = imgui.new.bool(true)
local buf_showTime = imgui.new.bool(true)
local buf_leftX = imgui.new.float(15.0)
local buf_leftY = imgui.new.float(0.0)
local buf_rightX = imgui.new.float(0.0)
local buf_rightY = imgui.new.float(0.0)
local buf_moneyX = imgui.new.float(0.0)
local buf_moneyY = imgui.new.float(15.0)
...
-- ============================================================================
-- CONFIG WINDOW (sliders only, no save)
-- ============================================================================
